    ...
    <View style={s.container}>
      ...
      {items.length === 0 ? (
        <View style={s.emptyWrap}>
          <View style={s.emptyIcon}><Ionicons name="cart-outline" size={56} color={RED} /></View>
...
const s = StyleSheet.create({
  ...
  qtyRow:           { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: YELLOW, borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4, marginRight: 10 },
  qtyBtn:           { padding: 3 },
