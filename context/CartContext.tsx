...
const FALLBACK_ITEMS = [
  { id: '1',  name: 'Grilled Chicken Burger', category: 'Grills',    price: 85,  icon: 'fast-food',   description: 'Juicy grilled chicken with fresh lettuce and house sauce', details: 'Served on a toasted brioche bun with house-made aioli, crisp lettuce, tomato, and pickles.', images: [] },
  { id: '2',  name: 'Beef Burger',            category: 'Burgers',    price: 90,  icon: 'fast-food',   description: 'Classic beef patty with cheese and pickles', details: '180g hand-pressed beef patty, double cheese, caramelised onions, gherkins and our signature smoky sauce.', images: [] },
  { id: '3',  name: 'Chicken Wings',          category: 'Arabic', price: 65,  icon: 'restaurant',  description: '6 crispy wings with your choice of sauce', details: 'Choose from BBQ, Peri-Peri, Honey Garlic or Buffalo. Served with blue cheese dip.', images: [] },
  ...
  { id: '5',  name: 'Caesar Salad',           category: 'Salads', price: 55,  icon: 'leaf',        description: 'Fresh romaine, croutons, parmesan and caesar dressing', details: 'Classic Caesar with house-made dressing, shaved parmesan, garlic croutons and a soft-boiled egg.', images: [] },
  { id: '6',  name: 'Grilled Steak',          category: 'Grills',    price: 160, icon: 'restaurant',  description: '200g sirloin steak cooked to your liking', details: 'Premium 200g sirloin, cooked to your preference. Served with garlic butter, seasonal vegetables.', images: [] },
