...
const SPECIALS = [
  { id: 'ws1', day: 'Monday', name: 'Coq au Vin', description: 'Classic French braised chicken in red wine.', details: 'Add your full description here.', price: 400, images: [require('../../assets/images/products/Coq au Vin1.jpeg'), require('../../assets/images/products/Coq au Vin2.jpeg')] },
  { id: 'ws2', day: 'Tuesday', name: 'Beef Bourguignon', description: 'Slow-cooked rich beef stew in Burgundy wine.', details: 'Add your full description here.', price: 400, images: [require('../../assets/images/products/Beef Bourguignon1.jpeg'), require('../../assets/images/products/Beef Bourguignon2.jpeg')] },
  { id: 'ws3', day: 'Wednesday', name: 'Seafood Paella', description: 'Classic Spanish seafood paella.', details: 'Add your full description here.', price: 400, images: [require('../../assets/images/products/Seafood Paella1.jpeg'), require('../../assets/images/products/Seafood Paella2.jpeg')] },
  { id: 'ws4', day: 'Thursday', name: 'Lamb Chops', description: 'Grilled lamb chops with herbs.', details: 'Add your full description here.', price: 400, images: [require('../../assets/images/products/Lamb Chops1.jpeg'), require('../../assets/images/products/Lamb Chops2.jpeg')] },
  { id: 'ws5', day: 'Friday', name: 'Garlic Butter Shrimp', description: 'Sizzling garlic butter shrimp.', details: 'Add your full description here.', price: 400, images: [require('../../assets/images/products/Garlic Butter Shrimp1.jpeg'), require('../../assets/images/products/Garlic Butter Shrimp2.jpeg')] },
  { id: 'ws6', day: 'Saturday', name: 'Seafood Stew', description: 'Hearty Mediterranean seafood stew.', details: 'Add your full description here.', price: 400, images: [require('../../assets/images/products/Seafood Stew1.jpeg'), require('../../assets/images/products/Seafood Stew2.jpeg')] },
];
  ...
  return (
    <View style={s.container}>
      ...
      <ScrollView contentContainerStyle={s.content}>
        <Text style={s.dayLabel}>{isSunday ? "Sunday — Choose Any Special!" : `Today: ${today}`}</Text>
...
const s = StyleSheet.create({
  ...
  title:        { fontSize: 18, fontWeight: '800', color: '#1a1612' },
  subtitle:     { fontSize: 11, color: RED, fontWeight: '700', letterSpacing: 0.5 },
  content:      { padding: 16 },
  dayLabel:     { fontSize: 20, fontWeight: '800', color: RED, marginBottom: 16, textAlign: 'center' },
  ...
  qtyRow:       { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#F3C3C5', borderRadius: 20, paddingHorizontal: 10, paddingVertical: 6, flexShrink: 0 },
  qtyBtn:       { padding: 2 },
  qtyText:      { fontSize: 14, fontWeight: '800', color: '#1a1612', minWidth: 18, textAlign: 'center' },
  tableWrap:    { backgroundColor: '#fff', borderRadius: 16, padding: 16, marginTop: 8 },
  tableTitle:   { fontSize: 16, fontWeight: '800', color: RED, marginBottom: 12, textAlign: 'center' },
  tableRow:     { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: '#FFD544' },
  tableDay:     { fontSize: 14, fontWeight: '700', color: '#1a1612' },
  tableDish:    { fontSize: 14, color: '#6b6b6b', flex: 1, textAlign: 'right' },
});
const modal = StyleSheet.create({
  backdrop: { flex: 1, backgroundColor: 'rgba(0,0,0,0.55)', justifyContent: 'flex-end' }, sheet: { backgroundColor: '#fff', borderTopLeftRadius: 24, borderTopRightRadius: 24, maxHeight: '92%' }, imageBox:    { width: SW, height: SW, backgroundColor: '#FADAD9', borderTopLeftRadius: 24, borderTopRightRadius: 24, overflow: 'hidden' }, navBtn: { position: 'absolute', top: '50%', marginTop: -22, backgroundColor: 'rgba(0,0,0,0.35)', borderRadius: 22, width: 44, height: 44, alignItems: 'center', justifyContent: 'center' }, backBtn: { position: 'absolute', top: 50, left: 14, flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#fff', borderRadius: 50, paddingHorizontal: 14, paddingVertical: 10, elevation: 5, zIndex: 10 }, backBtnText: { fontSize: 14, fontWeight: '700', color: '#1a1612' }, body: { padding: 20, paddingBottom: 60 }, name: { fontSize: 20, fontWeight: '800', color: '#1a1612', marginBottom: 8 }, desc: { fontSize: 14, color: '#6b6b6b', lineHeight: 22, marginBottom: 20 }, footer: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, price: { fontSize: 22, fontWeight: '800', color: RED }, cartCircle: { width: 48, height: 48, borderRadius: 24, backgroundColor: YELLOW, alignItems: 'center', justifyContent: 'center' }, qtyRow: { flexDirection: 'row', alignItems: 'center', gap: 14, backgroundColor: '#F3C3C5', borderRadius: 24, paddingHorizontal: 12, paddingVertical: 8 }, qtyBtn: { padding: 4 }, qtyText: { fontSize: 16, fontWeight: '800', color: '#1a1612', minWidth: 20, textAlign: 'center' },
});
