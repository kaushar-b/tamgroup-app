...
const styles = StyleSheet.create({
  ...
  heroTitle:    { fontSize: 26, fontWeight: '800', color: Colors.white, marginBottom: 4, marginTop: 12 },
  ...
  actionCard:   { flex: 1, backgroundColor: Colors.lightGrey, borderRadius: 14, padding: 18, alignItems: 'center', gap: 8 },
  ...
  infoTitle:    { fontSize: 15, fontWeight: '700', color: Colors.black },
  infoText:     { fontSize: 14, color: Colors.grey, lineHeight: 22, marginLeft: 24 },
