...
const DISHES = [
  ...
  {
    id: 'p2', name: 'Spanish Chorizo Paella',
    ...
    price: 175,
    images: [require('../../assets/images/products/chorizo paella1.jpeg')],
  },
  {
    id: 'p3', name: 'Spanish Vegetarian Paella',
